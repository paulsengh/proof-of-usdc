...
template TwitterResetRegex(msg_bytes) {
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_substr0[i][0] <== 0;
		is_substr0[i][1] <== is_substr0[i][0] + states[i+1][0] * states[i+2][12];
		is_substr0[i][2] <== is_substr0[i][1] + states[i+1][12] * states[i+2][12];
		is_substr0[i][3] <== is_substr0[i][2] + states[i+1][12] * states[i+2][16];
		is_substr0[i][4] <== is_substr0[i][3] + states[i+1][16] * states[i+2][1];
